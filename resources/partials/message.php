<?php
    ...
    if(isset($_SESSION['message'])): ?>
        <div class='d-flex flex-row align-items-center position-fixed end-0 top-0 m-2 p-0 shadow border border-<?php echo $_SESSION['type'] ?>  border-2 rounded bg-cm-light' data-message='true'>
