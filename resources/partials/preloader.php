...
<section class="section-preloader <?php echo $position ?> top-0 left-0 bg-cm-light flex justify-center items-center <?php echo $width_height ?>" id="preloader-section">
